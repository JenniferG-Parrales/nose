...
{
    public abstract class BaseSalaryC
    {
        ...
        protected decimal CalculateAnnualSalary(decimal salary)
        {
            return salary * 12;
        }
        protected decimal CalculateInss(decimal salary)
        {
            return salary * InssRate;
        }
        protected decimal CalculateIr(decimal annualSalary)
        {
